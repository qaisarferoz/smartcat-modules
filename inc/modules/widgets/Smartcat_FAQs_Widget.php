...
class Smartcat_FAQs_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        if ( file_exists( get_template_directory() . '/smartcat-modules/views/FAQs_Widget_View.php') ) : 
            include get_template_directory() . '/smartcat-modules/views/FAQs_Widget_View.php' ;
        else :
            include SMARTCAT_MODULES_PATH . 'inc/modules/views/FAQs_Widget_View.php';
        endif;
    ...
    public function form( $instance ) {
        ...
        echo '	<input type="text" id="' . $this->get_field_id( 'scmod_faqs_title' ) . '" name="' . $this->get_field_name( 'scmod_faqs_title' ) . '" class="widefat" placeholder="' . esc_attr__( '', 'smartcat-modules' ) . '" value="' . esc_attr( $scmod_faqs_title ) . '">';
        echo '</p>';
