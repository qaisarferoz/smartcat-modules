...
class Smartcat_Events_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        if ( file_exists( get_template_directory() . '/smartcat-modules/views/Events_Widget_View.php') ) : 
            include_once get_template_directory() . '/smartcat-modules/views/Events_Widget_View.php' ;
        else :
            include_once SMARTCAT_MODULES_PATH . 'inc/modules/views/Events_Widget_View.php';
        endif;
    ...
    public function form( $instance ) {
        ...
        $scmod_events_title         = !empty( $instance['scmod_events_title'] ) ? $instance['scmod_events_title'] : __( 'Events', 'smartcat-modules');
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['scmod_events_title']         = !empty( $new_instance['scmod_events_title'] ) ? strip_tags( $new_instance['scmod_events_title'] ) : __( 'Events', 'smartcat-modules');
