...
class Smartcat_Contact_Form_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) { 
        ...
        if ( file_exists( get_template_directory() . '/smartcat-modules/views/Contact_Form_Widget_View.php') ) : 
            include get_template_directory() . '/smartcat-modules/views/Contact_Form_Widget_View.php' ;
        else :
            include SMARTCAT_MODULES_PATH . 'inc/modules/views/Contact_Form_Widget_View.php';
        endif;
