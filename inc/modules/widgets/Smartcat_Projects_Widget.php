...
class Smartcat_Projects_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        if ( file_exists( get_template_directory() . '/smartcat-modules/views/Projects_Widget_View.php') ) : 
            include get_template_directory() . '/smartcat-modules/views/Projects_Widget_View.php' ;
        else :
            include SMARTCAT_MODULES_PATH . 'inc/modules/views/Projects_Widget_View.php';
        endif;
